    ...
    <div className="flex justify-between px-5 py-2.5 border-b-2 border-coffeeDark">
      ...
      <div className="w-[100%] flex justify-between align-middle">
        <Button
          ...
          title="Add task"
        />
        <SelectButton className="w-[90px] sm:w-[155px]" options={options} setFilter={setFilter} defaultValue={{ value: "all", label: "All" }} onChange={newValue => setFilter(newValue.value)}/>
      </div>
    </div>
  );
}
